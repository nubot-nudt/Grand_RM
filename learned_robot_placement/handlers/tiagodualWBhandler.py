...
class TiagoDualWBHandler(TiagoBaseHandler):
    ...
    def _set_dof_limits(self):# dof position limits
        ...
        # self.console_logger.info("Debug_tiagodualWB:dof_limits=%s" % (str(dof_limits)))
        # self.console_logger.info("Debug_tiagodualWB:type(dof_limits)=%s" % (str(type(dof_limits))))
        # self.console_logger.info("Debug_tiagodualWB:self._device=%s"%(str(self._device)))
    ...
    def _set_default_state(self):
        ...
        # self.console_logger.info("Debug:jt_pos=%s"%(jt_pos))
        # input("测试")
    ...
    def apply_actions(self, actions):
        ...
        # self.console_logger.info("====================apply_actions============")
    ...
    def apply_base_actions(self, actions):
        ...
        # self.console_logger.info("Debug_tiago:base_actions=%s"%(str(base_actions)))
        # self.console_logger.info("Debug_tiago:type(base_actions)=%s"%(type(base_actions)))
    ...
    def get_robot_obs(self):
        ...
        # Base rotation continuous joint should be in range -pi to pi，设置角度R在-pi到pi之间
        ...
        # self.console_logger.info("Debug:tiago_combined_pos=%s"%(str(combined_pos)))
        # self.console_logger.info("Debug:tiago_combined_vel=%s" % (str(combined_vel)))
        # self.console_logger.info("Debug:tiago:type(combined_pos)=%s"%(type(combined_pos)))
    ...
    def reset(self, indices, randomize=False):
        # self.console_logger.info("indices=%s"%(indices))
        ...
        # self.console_logger.info("jt_pos=%s, indices=%s"%(jt_pos, indices))
