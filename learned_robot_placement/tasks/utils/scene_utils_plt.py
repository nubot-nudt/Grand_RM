...
def setup_tabular_scene(self, obstacles, tabular_obstacle_mask, grasp_objs, obstacles_dimensions, grasp_objs_dimensions,
    ...
    for idx, _ in enumerate(grasp_objs):
        ...
        while (1):  # Be careful about infinite loops!
            ...
            # grasp_obj_yaw = 0.6
            if idx == 0:
                grasp_obj_yaw = 1.1935
            elif idx == 1:
                grasp_obj_yaw = -0.0951
            elif idx == 2:
                grasp_obj_yaw = 0.7643
            elif idx == 3:
                grasp_obj_yaw = -1.2697
            ...
            # print("idx=%d, pose=%s, grasp_obj_yaw=%s"%(idx, grasp_obj_position, grasp_obj_yaw))
            # compute new AxisAligned bbox
            self._scene._bbox_cache.Clear()
            grasp_obj_aabbox = self._scene.compute_object_AABB(grasp_objs[idx].name)
    ...
    # print("Debug1:object_positions=")
    # print(object_positions)
    #
    # print("Debug1:object_yaws=")
    # print(object_yaws)
    ...
    # print("Debug2:object_positions=")
    # print(object_positions)
    #
    # print("Debug2:object_yaws=")
    # print(object_yaws)
