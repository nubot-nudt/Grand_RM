...
def setup_tabular_scene(self, obstacles, tabular_obstacle_mask, grasp_objs, obstacles_dimensions, grasp_objs_dimensions,
    ...
    for idx, _ in enumerate(grasp_objs):
        ...
        while (1):  # Be careful about infinite loops!
            ...
            # if idx == 0:
            #     grasp_obj_x = tab_x + 0.20556924367568052
            #     grasp_obj_y = tab_y -0.18798840361801905
            # elif idx == 1:
            #     grasp_obj_x = tab_x -0.27560211032806736
            #     grasp_obj_y = tab_y +0.15827074362476345
            # elif idx == 2:
            #     grasp_obj_x = tab_x + 0.3155164818341646
            #     # grasp_obj_y = tab_y -0.1372846053840313
            #     grasp_obj_y = tab_y + 0.10888338456339425
            # else:
            #     grasp_obj_x = tab_x -0.13266538215856194
            #     grasp_obj_y = tab_y +0.20648549796468219
            """改变随机化测试"""
